...
function HeroSection() {
  return (
    <div
      className="h-[45rem] md:h-[45rem] flex flex-col justify-center items-center px-5 md:px-20 bg-black"
      id="home"
    >
      {/* big screens  */}
      <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center flex flex-col gap-3">
        <h1 className="mt-20 md:pt-28 md:mt-0 text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 pb-8 leading-[3.2rem] max-w-5xl mx-auto">
        ...
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-xl mx-auto">
          I&apos;m a skilled full stack web developer from Ahmedabad, Gujarat, India. I
